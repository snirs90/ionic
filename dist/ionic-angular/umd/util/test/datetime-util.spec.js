(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../datetime-util"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var datetime = require("../datetime-util");
    ...
    describe('parseTemplate', function () {
        ...
        it('should allow am/pm when using only 12-hour', function () {
        ...
        it('should not add am/pm when using 24-hour', function () {
            var formats = datetime.parseTemplate('HH:mm a');
            expect(formats.length).toEqual(2);
            expect(formats[0]).toEqual('HH');
            expect(formats[1]).toEqual('mm');
    ...
    describe('updateDate', function () {
        it('should update year in existing date', function () {
        ...
        it('should update hour AM in existing time', function () {
            var existingDate = { hour: 10, minute: 30, second: 0 };
...
//# sourceMappingURL=datetime-util.spec.js.map