(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../virtual-util", "../../../util/mock-providers"], factory);
    }
    ...
    describe('VirtualScroll', function () {
        ...
        describe('estimateHeight', function () {
            it('should return zero when no records', function () {
                var h = virtual_util_1.estimateHeight(0, undefined, 100, .25);
                expect(h).toEqual(0);
            });
        });
        ...
        describe('populateNodeData', function () {
            it('should set no nodes when no records', function () {
                nodes = [];
                records = [];
        ...
        describe('initReadNodes', function () {
            it('should get all the row heights w/ 30% width rows', function () {
                ...
                virtual_util_1.initReadNodes(mock_providers_1.mockPlatform(), nodes, cells, data);
...
//# sourceMappingURL=virtual-scroll.spec.js.map